...
// Modified version of DrawableProfileWeightedScore.
...
namespace osu.Game.Overlays.Cloudsu
{
    public class DrawableBestPerformanceScore : CompositeDrawable
    {
        ...
        public Action<int> SelectBeatmap;
            ...
            AddInternal(new ProfileItemContainer
            {
                Children = new Drawable[]
                {
                    new OsuClickableContainer
                    {
                        ...
                        Action = () => SelectBeatmap?.Invoke(Score.BeatmapInfoID),
                        Children = new Drawable[]
                        {
